...
class CampaignsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create campaign" do
    assert_difference('Campaign.count') do
      post campaigns_url, params: { campaign: { script: @campaign.script, status: @campaign.status, title: @campaign.title } }
    end
  ...
  test "should update campaign" do
    patch campaign_url(@campaign), params: { campaign: { script: @campaign.script, status: @campaign.status, title: @campaign.title } }
